	...
	<main role="main" class="container my-auto">
		<div class="row">
			<div id="registro" class="col-lg-4 offset-lg-4 col-md-6 offset-md-3
                    ...
                    <form  class="form-group" action="http://localhost:8080/ChavezChamorro-EduardoIsaac-Examen/RegistrarUsuario" method="post">
                    	<div class="form-group">      
                    		<label style="color: white; font-size: 20px; padding-top: 15px" for="nombre">Nombre</label>
                            <input style="font-size: 20px" class="form-control" id="nombre" name="nombre" class="form-control" placeholder="Nombre...">
